...
mps_loaded = loadMPS("/Users/joshua/Documents/QuantumInspiredML/LogLossAlternative/generative_experiment/cardiac_arrhythmia/chi15_mps.h5");
...
function plot_forecasting_example(class_idx::Int, sample_idx::Int, num_shots::Int; num_tpts_forecast=50)
    ...
    _ = compute_all_metrics(training, forecast, actual; print_table=true)
    display(p)
end
