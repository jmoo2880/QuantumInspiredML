...
# dloc =  "Interpolation/paper/NASA_kepler/c6/H_s125.jld2"
# f = jldopen(dloc, "w")
...
opts=Options(; nsweeps=10, chi_max=35,  update_iters=1, verbosity=verbosity, dtype=dtype, loss_grad=loss_grad_KLD,
...
if save
    ...
    svpath = "Interpolation/paper/NASA_kepler/mps_saves/legendreNN2_d12_chi35.jld2"
    f = jldopen(svpath, "w")
